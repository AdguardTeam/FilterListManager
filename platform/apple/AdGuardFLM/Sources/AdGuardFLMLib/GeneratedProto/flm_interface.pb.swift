...
public struct FilterListManager_FetchFilterListMetadataWithBodyRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct FilterListManager_GetRulesCountRequest {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct FilterListManager_FetchFilterListMetadataWithBodyResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct FilterListManager_GetRulesCountResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct FilterListManager_PullMetadataResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension FilterListManager_FetchFilterListMetadataWithBodyRequest: @unchecked Sendable {}
...
extension FilterListManager_GetRulesCountRequest: @unchecked Sendable {}
...
extension FilterListManager_FetchFilterListMetadataWithBodyResponse: @unchecked Sendable {}
...
extension FilterListManager_GetRulesCountResponse: @unchecked Sendable {}
extension FilterListManager_PullMetadataResponse: @unchecked Sendable {}
