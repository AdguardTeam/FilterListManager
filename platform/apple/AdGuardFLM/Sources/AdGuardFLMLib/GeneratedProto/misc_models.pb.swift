...
/// ActiveRulesInfo
public struct FilterListManager_ActiveRulesInfo {
...
/// UpdateResult
public struct FilterListManager_UpdateResult {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// UpdateFilterError
public struct FilterListManager_UpdateFilterError {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct FilterListManager_MovedFilterInfo {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  //// Previous id of the filter
  public var previousID: Int32 = 0
...
public struct FilterListManager_PullMetadataResult {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// List of filters added in the update
  public var addedFilters: [Int32] = []

  /// List of filters removed in the update
  public var removedFilters: [Int32] = []

  /// List of filters moved in the update
  public var movedFilters: [FilterListManager_MovedFilterInfo] = []
...
extension FilterListManager_ActiveRulesInfo: @unchecked Sendable {}
extension FilterListManager_UpdateResult: @unchecked Sendable {}
extension FilterListManager_UpdateFilterError: @unchecked Sendable {}
extension FilterListManager_MovedFilterInfo: @unchecked Sendable {}
extension FilterListManager_PullMetadataResult: @unchecked Sendable {}
...
extension FilterListManager_MovedFilterInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".MovedFilterInfo"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt32Field(value: &self.previousID) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.previousID != 0 {
      try visitor.visitSingularInt32Field(value: self.previousID, fieldNumber: 1)
    }
    if self.newID != 0 {
  ...
  public static func ==(lhs: FilterListManager_MovedFilterInfo, rhs: FilterListManager_MovedFilterInfo) -> Bool {
...
extension FilterListManager_PullMetadataResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".PullMetadataResult"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "added_filters"),
    2: .standard(proto: "removed_filters"),
    3: .standard(proto: "moved_filters"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedInt32Field(value: &self.addedFilters) }()
      case 2: try { try decoder.decodeRepeatedInt32Field(value: &self.removedFilters) }()
      case 3: try { try decoder.decodeRepeatedMessageField(value: &self.movedFilters) }()
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.addedFilters.isEmpty {
      try visitor.visitPackedInt32Field(value: self.addedFilters, fieldNumber: 1)
    }
    if !self.removedFilters.isEmpty {
      try visitor.visitPackedInt32Field(value: self.removedFilters, fieldNumber: 2)
    }
    if !self.movedFilters.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.movedFilters, fieldNumber: 3)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  public static func ==(lhs: FilterListManager_PullMetadataResult, rhs: FilterListManager_PullMetadataResult) -> Bool {
    if lhs.addedFilters != rhs.addedFilters {return false}
    if lhs.removedFilters != rhs.removedFilters {return false}
    if lhs.movedFilters != rhs.movedFilters {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
