...
public struct FilterListManager_FilterListMetadataWithBody {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct FilterListManager_RulesCountByFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension FilterListManager_FilterListMetadataWithBody: @unchecked Sendable {}
...
extension FilterListManager_RulesCountByFilter: @unchecked Sendable {}
