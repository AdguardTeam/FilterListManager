    ...
    : AutoCloseable
{
    ...
    init {
        val configBytes = configuration.encode()
    ...
    actual companion object {
        ...
        actual fun generateRandomKey(): RustResponse? {
            val nativeResponse = flm_generate_random_key_protobuf()
            if (nativeResponse == null) {
                FlmLogger.error("flm_generate_random_key_protobuf returned null")
                return null
            }
