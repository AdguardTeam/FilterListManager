    ...
    : AutoCloseable
{
    ...
    companion object {
         ...
         *
         * This is a standalone native function that does not require an FLM instance.
         * The key can be used as an integrity_key in Configuration.
         *
         * @return RustResponse containing the serialized GenerateRandomKeyResponse,
         *         or null if the native call fails
         */
        fun generateRandomKey(): RustResponse?
    }
