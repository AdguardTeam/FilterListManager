...
impl From<Configuration> for filter_list_manager::Configuration {
    fn from(value: Configuration) -> Self {
        ...
        Self {
            ...
            should_ignore_expires_for_local_urls: value.should_ignore_expires_for_local_urls,
...
impl From<filter_list_manager::Configuration> for Configuration {
    fn from(val: filter_list_manager::Configuration) -> Self {
        ...
        Configuration {
            ...
            should_ignore_expires_for_local_urls: val.should_ignore_expires_for_local_urls,
